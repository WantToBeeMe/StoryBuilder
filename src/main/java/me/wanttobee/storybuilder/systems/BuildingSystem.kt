...
object BuildingSystem {
    ...
    fun buildSentence(commander:Player, sentence : List<String>){
        buildWord(commander,sentence[0])
    }

    fun buildWord(commander: Player, word: String){
        val firstChar = word[0]
        val glyphVector = FontSystem.font.createGlyphVector(fontRenderContext, firstChar.toString())
